...
def main():
    path_orig = '/home/jnejati/page_speed/mobile_wifi-yi_yilist_orig_compression/temp_files/'
    path_mod = '/home/jnejati/page_speed/mobile_wifi-yi_yilist_modified_compression/temp_files/'
    ouput_set = set()
    dirs_orig = os.listdir(path_orig)  # return list of files in path
    dirs_mod = os.listdir(path_mod)  # return list of files in path
    my_dict = {}
    my_dict_n = {}
    write_file = open(os.path.join('/home/jnejati/page_speed', 'worth_to_compress.txt'), 'w')
