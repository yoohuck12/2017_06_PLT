if(typeof(AC)==="undefined"){AC={}}if(typeof(AC.addEvent)==="undefined"){AC.addEvent=function(d,e,f){if(d.addEventListener){return d.addEventListener(e,f,false)
}return d.attachEvent("on"+e,f)}}if(typeof(AC.Storage)!=="object"){AC.Storage={getItem:function(){},getItemObject:function(){},setItem:function(){}}
}else{if(typeof(AC.Storage.getItem)!=="function"){AC.Storage.getItem=function(){}
}if(typeof(AC.Storage.getItemObject)!=="function"){AC.Storage.getItemObject=function(){}
}if(typeof(AC.Storage.setItem)!=="function"){AC.Storage.setItem=function(){}}}var FeedStatistics=function(){if(typeof(aiRequestsEnabled)!=="undefined"&&aiRequestsEnabled===false){return
...
};if(typeof(AC.onDOMReady)==="function"){AC.onDOMReady(function(){if(typeof(aiRequestsEnabled)!=="undefined"&&aiRequestsEnabled!==false){var b=new FeedStatistics();
