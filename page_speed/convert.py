...
class Convert():
    ...
    def do_analysis(self, profile, orig_modified, imp_type):
        ...
        for dirpath, dirnames, files in os.walk('/home/jnejati/page_speed/tests/analysis_t/graphs/'):
            if files:
                os.system('cp /home/jnejati/page_speed/tests/analysis_t/graphs/* ' + os.path.join('/home/jnejati/page_speed/' + graphs_dir, 'graphs/'))
        ...
        for dirpath, dirnames, files in os.walk('/home/jnejati/page_speed/tests/analysis_t/temp_files/pre_log_pro/'):
            if files:
                os.system('cp /home/jnejati/page_speed/tests/analysis_t/temp_files/pre_log_pro/* ' + os.path.join('/home/jnejati/page_speed/' + graphs_dir, 'temp_files/'))
                print("json files copied ")
                break
            else:
                print(dirpath, 'is empty, No Json file copied')
